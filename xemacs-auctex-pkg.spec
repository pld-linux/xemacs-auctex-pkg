...
%description -l pl 
AUC TeX jest kompletnym i konfigurowalnym ¶rodowiskiem edycji plików ¼ród³owych
LaTeX-a, dostêpnym w programach GNU Emacs i XEmacs.

AUC TeX umo¿liwia uruchamianie narzêdzi pakietu TeX/LaTeX i innych, takich jak konwertery czy filtry z wewn±trz programu [X]Emacs. Szczególnie interesuj±ca jest opcja "Running LaTeX", poniewa¿ pozwala ona przegl±daæ wiadomo¶ci o b³êdach w plikach ¼ród³owych, przesuwaæ kursor od razu w miejsce wyst±pienia b³êdu i czytaæ pliki dokumentacji dotycz±ce tego b³êdu. Funkcja dzia³a poprawnie nawet dla dokumentów sk³adaj±cych siê z kilku plików ¼ród³owych.

AUC TeX w sposób automatyczny formatuje plik ¼ród³owy LaTeX-a, zarówno na bie¿±co jak i po wpisaniu. Posiada specjaln± funkcjê "zarysu dokumentu", która wydatnie pomaga przegl±daæ dokumenty.

Poza powy¿szymi specja³ami, AUC TeX dostarcza wiele u¿ytecznych makr, pomocnych w szybkiej i bezbolesnej edycji dokumentów LaTeX-a.
